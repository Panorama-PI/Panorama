...
function cadastrar(nome, email, senha, cargo, fkEmpresa) {
    ...
    var instrucaoSql = `
        INSERT INTO usuario (nome, email, senha, cargo, fkEmpresa) VALUES ('${nome}', '${email}', '${senha}','${cargo}', '${fkEmpresa}');
    `;
    console.log("Executando a instrução SQL: \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
...
function buscarUsuariosPorEmpresa(empresaId) {
  ...
  var instrucaoSql = `SELECT * FROM usuario a WHERE fkEmpresa = ${empresaId}`;
